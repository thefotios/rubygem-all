# Generated from dm-types-1.2.1.gem by gem2rpm -*- rpm-spec -*-
%global gemname dm-types
...
Requires: ruby 
Requires: rubygem(bcrypt-ruby) => 3.0.0
Requires: rubygem(bcrypt-ruby) < 3.1
...
Requires: rubygem(stringex) => 1.3.0
Requires: rubygem(stringex) < 1.4
Requires: rubygem(uuidtools) => 2.1.2
Requires: rubygem(uuidtools) < 2.2
